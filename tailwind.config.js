  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-mesh": "radial-gradient(ellipse 80% 60% at 70% 20%, rgba(64, 145, 108, 0.15), transparent), radial-gradient(ellipse 60% 50% at 10% 80%, rgba(201, 162, 39, 0.08), transparent)",
      },
    },
  },
  plugins: [],
